...
const Navbar = () => {
  ...
  return (
    <nav
      className="backdrop-blur-lg border-b z-50 sticky top-0"
      style={{
      ...
      <div className="w-full px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              to="/login"
              className="text-slate-300 hover:text-red-400 transition-colors p-2 rounded-lg hover:bg-red-400/10"
              title="Logout"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-slate-600/30 bg-slate-800/20 backdrop-blur-lg">
